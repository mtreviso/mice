...
PREDICTOR_DIR=trained_predictors/1230

#allennlp train src/predictors/snli/snli_t5.json \
#        --include-package src.predictors.snli.snli_dataset_reader \
#        --include-package src.predictors.t5_classifier \
#        -s trained_predictors/1230/snli/model \
...
: '
CUDA_VISIBLE_DEVICES=6 python run_stage_one.py -task snli \
